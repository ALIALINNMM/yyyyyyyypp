import datetime;now = datetime.date.today();target = datetime.date(2024,3,15)
if now >=target:exit("توقفت اداتي تريد افعلها تعالي خاص @TI_8Q")
print("دشغهلة")
...
time.sleep(2)
os.system(f'xdg-open https://t.me/u7m_7 ')
try:
...
ugen=[] 
useragent=[]
header_grup = {"user-agent": "Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.102 Safari/537.36 "}
header_grup = {"user-agent": "Mozilla/5.0 (X11; Ubuntu; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/85.0.4183.81 Safari/537.36"}
header_grup = {"user-agent": "Mozilla/5.0 (Windows NT 5.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/84.0.4147.105 Safari/537.36]"}
for xd in range(10000):
        aa='Mozilla/5.0 (Linux; Android 10; Nokia 1 Plus Build/Q1A.190711.020; wv)'
...
def Fof():
		...
		with tred(max_workers=30) as crack_submit:
			...
			print(f"\033[1;36m  VIP »»»»» \033[1;32m @U7M_U | IG: bxbt_ | @u7m_7  \033[1;31m ANONYMOUS")
			linex()
			for user in fo:
